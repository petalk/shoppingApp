            ...
            <div class="container">
                <div class="col-md-3" id="footerCol1">
                   <a href="<?php echo base_url();?>" id="siteName">
                        <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()"><img id="ftlogo" src="<?php echo base_url();?>images/LOGO1.png" id></span></h2>
                        <h1 style="margin:0px;"><span class="largenav"><img id="ftlogo" src="<?php echo base_url();?>images/LOGO1.png" id></span></h1>
