...
<!--                        <li class="upper-links dropdown"><a class="links" href="http://clashhacks.in/">Dropdown</a>
                ...
                <div class="row row2">
                    <div class="col-sm-2">
                        ...
                        <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()"><img id="logo" src="<?php echo base_url();?>images/LOGO1.png" id></span></h2>
                        <h1 style="margin:0px;"><span class="largenav"><img id="logo" src="<?php echo base_url();?>images/LOGO1.png" id></span></h1>
                        </a>
                    </div>
                    <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                        <div class="row">
                            <input id="searchInp" ng-model="searchInp" class="flipkart-navbar-input col-xs-11" type="" placeholder="Search for Products, Brands and more" name="">
                            <button id="searchBut" ng-click="searchBut()" onclick="showSearch()" class="flipkart-navbar-button col-xs-1">
                    ...
                    <div class="cart col-sm-2">
                        <a href="<?php echo base_url();?>index.php/ShoppingController" class="cart-button">
